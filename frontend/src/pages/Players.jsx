...
import { sendRequest,getSentRequests} from "../api/connectionApi";
...
<> <Header />
  ...
  <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 py-10 px-6">
   ...
   <div className="bg-white/95 backdrop-blur-md rounded-2xl p-4 mb-8 shadow-lg max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-3">
          ...
          <select
           ...
           className="md:w-56 border border-gray-300 px-4 py-3 rounded-xl focus:border-blue-500"
          >
            <option value="All">
              All Sports
            </option>
        ...
        {filteredPlayers.map((player) => (
          ...
          >
            ...
            <div className="text-center -mt-12 p-6">
              ...
              <p className="text-gray-600 mt-3 min-h-[45px] text-sm">
                {player.bio ||
                  "No bio available"}
              </p>
 ...
 <Link
  ...
  className="flex-1"
>
  <button className="w-full py-2.5 rounded-xl font-semibold border border-blue-500 text-blue-600 hover:bg-blue-50">
    View Profile
  </button>
</Link>
