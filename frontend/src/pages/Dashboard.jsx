...
function Dashboard() {
  ...
  <Link to="/players">
    <button className="w-full bg-blue-600 hover:bg-blue-700 p-4 rounded-xl font-semibold transition">
      🎯 Find Players
    </button>
  </Link>

  <Link to="/requests">
    <button className="w-full bg-green-500 hover:bg-green-600 p-4 rounded-xl font-semibold transition">
      📨 Match Requests
    </button>
  ...
  <Link to="/ai">
  <button className="w-full bg-purple-500 hover:bg-purple-600 p-4 rounded-xl font-semibold transition">
    🤖 AI Suggestions
  </button>
</Link>

  <Link to="/connections">
    <button className="w-full bg-orange-500 hover:bg-orange-600 p-4 rounded-xl font-semibold transition">
      💬 Messages
    </button>
  </Link>
