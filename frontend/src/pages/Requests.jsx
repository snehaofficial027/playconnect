...
function Requests() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-100 via-blue-50 to-green-50 py-12 px-6">
                  ...
                  <div className="p-6 -mt-12">
                    ...
                    <div className="flex justify-center gap-2 mt-4 flex-wrap">
                      ...
                      <span className="bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm">
                        {req.sender?.skillLevel}
                      </span>

                    </div>

                    <p className="text-center text-gray-600 mt-5 min-h-[50px]">
                      {req.sender?.bio ||
